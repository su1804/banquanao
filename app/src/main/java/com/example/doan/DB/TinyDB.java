...
public class TinyDB {
    ...
    public ArrayList<menu_domain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<menu_domain> playerList =  new ArrayList<menu_domain>();

        for(String jObjString : objStrings){
            menu_domain player  = gson.fromJson(jObjString,  menu_domain.class);
    ...
    public void putListObject(String key, ArrayList<menu_domain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(menu_domain player: playerList){
